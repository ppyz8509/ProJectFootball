<?php include "../Controller/controllerDel.php";?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="row ">
            <div class="col ">
                ...
                <div class="card p-3 border" style="background-image: url('../data/images/BG-D.png');">
                    <br>
                    <center>
                        <h1><i class="bi bi-bookmark-check-fill">&nbsp;&nbsp;</i>
                            การทำรายการเสร็จสิ้น..
                        </h1>
                    </center>
                    <br>
                    <br>
                    <center>
                        <img class="card-img-top" src="https://media.giphy.com/media/l2JhIUyUs8KDCCf3W/giphy.gif" alt="..." height="500"/>
                    <br>
                    <br>
